...
learning_rate = 0.00025      # How fast to learn (higher = faster but less stable)
n_episodes = 2000           # Number of hands to practice
start_epsilon = 1          # Start with 90% random actions
epsilon_decay = .995        # start_epsilon / (n_episodes / 2)  # Reduce exploration over time
